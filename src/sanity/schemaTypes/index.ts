...
import { furniroSection } from './landindPage-sections/furniroSection'
import { userSchema } from './user'


export const schema: { types: SchemaTypeDefinition[] } = {
  types: [blogPage,blogMain,category,relatedPost,product,comment,landingPage,hero,browseSection,furniroSection,ourProducts,mainBox,pC,relatedProduct,relatedProductSection,userSchema],
}
